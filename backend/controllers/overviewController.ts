...
const isValidYmdDate = (value: string): boolean => {
...
export const getOverviewDailyCountsController = async (
  req: Request,
  res: Response,
) => {
...
export const getOverviewDateBoundsController = async (
  _req: Request,
  res: Response,
) => {
  try {
